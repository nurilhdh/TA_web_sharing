...
<body>
    ...
    <div class="container">
        <div class="row custom-section d-flex align-items-center">
            <div class="col-12 col-lg-4">
                <h3>Secure Your File</h3>
                <!-- <h2>Process</h2> -->
                <p>File Sharing is activity of sharing or providing data access to digital media on the internet to others</p>
    ...
    <!-- <footer class="footer">
        <hr/>
    &copy2022. Developed by Nuril Hidayah
    <br/>
    Secure File Sharing
    <br/>
